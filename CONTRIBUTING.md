...
The following is a set of guidelines for contributing to _mdcat_, which are hosted in the [mrinjamul/mdcat](https://github.com/mrinjamul/mdcat) on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
